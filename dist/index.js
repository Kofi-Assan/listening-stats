...
2. Run: spicetify apply`
  ...
  var StatsPage = class extends Spicetify.React.Component {
    constructor(props) {
      ...
      this.checkUpdates = async (forceShow = false) => {
    ...
    render() {
      ...
      return /* @__PURE__ */ Spicetify.React.createElement("div", { className: "stats-page" }, showUpdateModal && updateInfo && /* @__PURE__ */ Spicetify.React.createElement(
        ...
        /* @__PURE__ */ Spicetify.React.createElement("div", { className: "modal-content update-modal", onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ Spicetify.React.createElement("div", { className: "modal-header" }, /* @__PURE__ */ Spicetify.React.createElement("div", { className: "modal-icon" }, "\u{1F389}"), /* @__PURE__ */ Spicetify.React.createElement("div", { className: "modal-title" }, "Update Available!"), /* @__PURE__ */ Spicetify.React.createElement("div", { className: "modal-subtitle" }, "v", updateInfo.currentVersion, " \u2192 v", updateInfo.latestVersion)), updateInfo.changelog && /* @__PURE__ */ Spicetify.React.createElement("div", { className: "modal-changelog" }, updateInfo.changelog), /* @__PURE__ */ Spicetify.React.createElement("div", { className: "modal-instructions" }, /* @__PURE__ */ Spicetify.React.createElement("div", { className: "instruction-title" }, "After downloading:"), /* @__PURE__ */ Spicetify.React.createElement("div", { className: "instruction-text" }, navigator.platform.includes("Win") ? getInstallInstructions().windows : getInstallInstructions().linux)), /* @__PURE__ */ Spicetify.React.createElement("div", { className: "modal-actions" }, /* @__PURE__ */ Spicetify.React.createElement(
          "button",
          {
